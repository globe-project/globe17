...
// Copyright (c) 2025 The Globe developers
...
public:
    explicit DestinationEncoder(const CChainParams& params, bool fBech32 = false) : m_params(params), m_bech32(fBech32) {}
...
void CBase58Data::SetData(const std::vector<unsigned char>& vchVersionIn, const void* pdata, size_t nSize)
{
    ...
    fBech32 = Params().IsBech32Prefix(vchVersionIn);
...
bool CBase58Data::SetString(const char* psz, unsigned int nVersionBytes)
{
    ...
    fBech32 = Params().IsBech32Prefix(psz, strlen(psz), prefixType);
    if (fBech32) {
