...
{
    return m_batch.Read(std::make_pair(std::string("ek32"), identifier), ek32);
}
...
{
    return m_batch.Read(std::make_pair(std::string("eacc"), identifier), ekAcc);
}
...
{
    return m_batch.Read(PackKey("epak", identifier, nPack), ekPak);
}
...
{
    return m_batch.Read(PackKey("espk", identifier, nPack), aksPak);
}
...
{
    return m_batch.Read(PackKey("ecpk", identifier, nPack), asckPak);
}
