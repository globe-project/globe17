...
QT_MOC_LITERAL(1, 15, 14), // "radioSelection"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 13) // "buttonClicked"

    },
    "MnemonicDialog\0radioSelection\0\0"
    "buttonClicked"
};
...
void MnemonicDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MnemonicDialog *_t = static_cast<MnemonicDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->radioSelection(); break;
...
const QMetaObject MnemonicDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_MnemonicDialog.data,
      qt_meta_data_MnemonicDialog,  qt_static_metacall, nullptr, nullptr}
};
